            ...
            <section className="container contain-home">
                <div className="row align-items-center px-5 g-5">
                    ...
                    <div className="col-md-6 order-2 order-md-1 home-left mt-4">
                        <AnimateOnScroll animation={'animate__fadeInUpBig'}>
                    ...
                    {/* Right: card / avatar */}
                    <div className="col-md-6 order-1 order-md-2 mb-5 mb-md-0 home-right animate__fadeInDownBig animate__animated">
