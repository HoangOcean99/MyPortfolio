        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-7 col-sm-12 contain-intro">
            ...
            <p className="fs-5 intro-p">
              ...
              <ReactTyped
                strings={[
                  "Hello, my name is HoanDuongnDuongnpmllstack Developer passionate about turning ideas into meaningful digital products. I have experience working in both Frontend and Backend development. My strengths are fast learning, time management, adaptability to new technologies, and a creative problem-solving mindset. I believe that a great product is not only about smooth functionality but also about delivering a positive user experience. Beyond coding, I’m deeply interested in AI, UI/UX design, technology infrastructure, and building real-world applications. My goal is to become a well-rounded developer who can contribute throughout the entire process—from ideation and design to deployment and system operation—ensuring every project meets both customer and business needs."
                ]}
                typeSpeed={17}
              />
            </p>
